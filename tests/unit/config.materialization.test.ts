...
describe("repository worktree materialization configuration RED", () => {
  ...
  test.each([
    ...
    ["bad<name", "must not contain Windows-invalid characters"],
    ["bad>name", "must not contain Windows-invalid characters"],
    ['bad"name', "must not contain Windows-invalid characters"],
    ["bad|name", "must not contain Windows-invalid characters"],
    ["bad?name", "must not contain Windows-invalid characters"],
    ["bad*name", "must not contain Windows-invalid characters"],
    ["bad\u0001name", "must not contain Windows-invalid control characters"],
    ["bad\nname", "must not contain Windows-invalid control characters"],
    ["bad\tname", "must not contain Windows-invalid control characters"],
    ["bad\u001fname", "must not contain Windows-invalid control characters"],
