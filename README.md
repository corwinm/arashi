...
You can also build from source for local development. This requires Node.js 22 or newer and pnpm 11.12.0; nvm users can select the repository's development runtime with `nvm use`.
